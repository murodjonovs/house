                            ...
                            <div class="swiper-slide">
                                <div class="main__slider-frame" data-swiper-parallax-opacity="0">
                                    <div class="main__slider-photo" data-swiper-parallax="-100"
                                        ...
                                        <div class="main__bg">
                                            <img src="{{ $mainslider->photo }}" alt="photo">
                                        </div>
                                        <!-- /.main__bg -->
                                    </div>
                                            ...
                                            <div class="main__list">
                                                @if ($mainslider->parametrs != null)
                                                    ...
                                                    <div class="main__list-box">
                                                        <span class="general-M">{{$parametr['name']}}</span>
                                                        <p class="general-Db">{{$parametr['area']}}</p>
                                                    </div>
                                                    <!-- /.main__list-box -->
                                                    @endforeach
                                                @endif
                        ...
                        <a href="{{$dowload->photo}}" download="{{$dowload->photo}}" class="about__download">
                            <span class="ico">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path d="M15.5575 11.1106L12 14.6678L8.4425 11.1106" stroke="white" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M12 3.9967V14.6682" stroke="white" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path
                                        d="M20.0033 16.4457C20.0033 18.4103 18.4106 20.0029 16.4458 20.0029H7.55412C5.58938 20.0029 3.99664 18.4103 3.99664 16.4457"
                    ...
                    <div class="swiper-container about__slider" data-aos="fade-left">
                        ...
                        <div class="about__slider-buttons">
                            <button class="about__slider-btn about__slider-prev">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M14 15.8794L10 11.9096L14 7.9397" stroke="#966C53" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </button>
                            <!-- /.about__slider-btn -->
                            <button class="about__slider-btn about__slider-next">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10 15.8794L14 11.9096L10 7.9397" stroke="white" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </button>
                            <!-- /.about__slider-btn -->
                        ...
                        <div class="architect__box architect__box-1">
                            <div class="architect__btn">
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M10.6312 13.2751H5V10.7249H10.6312V5H13.3677V10.7249H19V13.2751H13.3688V19H10.6323L10.6312 13.2751Z"
                                        fill="#966C53" />
                                </svg>
                            </div>
                            <!-- /.architect__btn -->
            ...
            <div class="general__container">
                <div class="infrstr">
                    ...
                    <div class="swiper-container infrstr__slider" data-aos-delay="200" data-aos="fade-right">
                        <div class="swiper-wrapper">
                            @foreach ($secondslider->where('slider_number', 2) as $secondslid)
                            <div class="swiper-slide">
        ...
        <section class="section__yard">
            ...
            <div class="yard__container" data-aos-delay="200" data-aos="fade-up">
                ...
                <div class="swiper yard__slider general__slider">
                    <div class="swiper-wrapper">
                        @foreach ($secondslider->where('slider_number', 3) as $secondslid)
                        <div class="swiper-slide">
            ...
            <div class="general__container">
                <div class="hall">
                    ...
                    <div class="swiper-container hall__slider" data-aos-delay="500" data-aos="fade-left">
                        <div class="swiper-wrapper">
                            @foreach ($secondslider->where('slider_number', 4) as $secondslid)
                            <div class="swiper-slide">
                                <div class="infrstr__slider-frame" data-swiper-parallax-opacity="0">
        ...
        <section class="section__commercial">
            ...
            <div class="commercial__container" data-aos-delay="300" data-aos="fade-up">
                <div class="swiper commercial__slider general__slider">
                    <div class="swiper-wrapper">
                        @foreach ($secondslider->where('slider_number', 5) as $secondslid)
                        <div class="swiper-slide">
                            <div class="general__slider-photo">
                                <img src="{{$secondslid->photo}}" alt="photo">
                            </div>
            ...
            <div class="general__container">
                <div class="parking">
                    ...
                    <div class="swiper-container parking__slider" data-aos-delay="300" data-aos="fade-right">
                        <div class="swiper-wrapper">
                            @foreach ($secondslider->where('slider_number', 6) as $secondslid)
                            <div class="swiper-slide">
